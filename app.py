...
from backend.claude_service import (
    stream_response as claude_stream_response,
    generate_title as claude_generate_title,
    generate_email,
)
...
async def conversation_internal(request_body, request_headers):
    try:
        ...
        result = claude_stream_response(messages, history_metadata)
...
async def add_conversation():
    ...
    try:
        ...
        if not conversation_id:
            title = await claude_generate_title(request_json["messages"])
